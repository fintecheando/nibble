...
<tr>
	<td><img src="images/tnc5_3.GIF"></td>
        ...
        <th>
	<td><a href="../nctx/hlp/nc5.0-5.3.htm#desasociar" target="Ayuda Asociación de Proveedores">Ayuda</a></td>
        </th>
...
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
	<tr class="titStyle">
		<td align=center><input type="submit" value="Desasociar" class=body onclick="return desasociar_onclick(this.form)" <%if (bean52.getProveedoresSize()==0) {%>DISABLED <%}%> >	</td>
	</tr>
</table>
<br>
