...
<jsp:useBean id="bean62c" class="org.nibble.service.vo.partes.Bean62c" scope="session"/>
...
<input type=hidden name="liidparte" value="<%= bean62c.getLiidparte()%>">
...
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
	...
	<tr class="itemStyle">
	<td colspan=4><input type=text name="vchnumparte" class="body" size=16 value="<%= bean62c.getVchnumparte() %>"></td>
	<td><input type=text name="fllargo" class="body" size=4 value="<%= bean62c.getFllargo() %>" onkeypress="return numbersonly()" ></td>
	<td><input type=text name="flalto" class="body" size=4 value="<%= bean62c.getFlalto() %>" onkeypress="return numbersonly()"></td>
	<td><input type=text name="flancho" class="body" size=4 value="<%= bean62c.getFlancho() %>" onkeypress="return numbersonly()"></td>
	<td><input type=text name="flpeso" class="body" size=4 value="<%= bean62c.getFlpeso() %>" onkeypress="return numbersonly()"></td>
	</tr>
</table>
<br>
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
	...
	<tr class="itemStyle">
		<td width="20%"> <select id="iidunidad" name="iidunidad" class="body">
			<%for (int i=0; i<bean62c.getSize();i++){%>
				<option value=<%= bean62c.getIidunidad(i) %>  <% if  (bean62c.getIidunidad(i)== bean62c.getIidunidad()){%> SELECTED <% } %> ><%= bean62c.getVchdescripcion(i) %></option>
			<%}%>
  			</select>
                </td>
		<td> <input type=text name="decpreciob100" class="body" size=10 value="<%= bean62c.getDecpreciob100() %>" onkeypress="return numbersonly()"> </td>
		<td> <input type=text name="imultiploempaque" class="body" size=5 value="<%= bean62c.getImultiploempaque() %>" onkeypress="return numbersonly()"> </td>
		<td> <input type=text name="iminembarque" class="body" size=5 value="<%= bean62c.getIminembarque() %>" onkeypress="return numbersonly()"> </td>
		<td> <input type=radio name="bitventaunitaria" value=Si <%if (bean62c.isBitventaunitaria()){%> checked <% } %>>Si <input type=radio name="bitventaunitaria" value=No <%if (!bean62c.isBitventaunitaria()){%> checked <% } %>>No  </td>
    </tr>
</table>
<br>
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
...
<tr class="itemStyle">
	<td><textarea name="vchdescripciones" rows="4" cols="100" class="body"><%= bean62c.getVchdescripciones() %></textarea></td>
</tr>
<tr class="titStyle">
	<td>Observaciones</td>
</tr>
<tr class="itemStyle">
	<td><textarea name="vchobservaciones" rows="4" cols="100" class="body"><%= bean62c.getVchobservaciones() %></textarea></td>
</tr>
<tr class="titStyle">
	<td>Ficha Técnica</td>
</tr>
<tr class="itemStyle">
	<td><textarea name="fichatecnica" rows="4" cols="100" class="body"><%= bean62c.getFichatecnica() %></textarea></td>
</tr>
</table>
<br>
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
<tr class="titStyle">
	<td align=center><input type="submit" value="Modificar" class=body onclick="return agregar_onclick(this.form)"></td>
</tr>
</table>
<br>
<table class="tablatext" width=750 align="center" cellpadding="0" cellspacing="0">
