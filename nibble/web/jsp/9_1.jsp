...
<tr class="itemStyle">
	...
	<tr><td align="right"><%if (!bean91.isMostradorSinIVA()){%>Descuento<%}%></td>
        ...
        <tr>
            <td align="right" colspan=2>Motivo Descuento</td>
            <td><input type=text name="motivoDescuento" class="body" size=16 value="<%= bean91.getMotivoDescuento()%>"></td>
...
<input type="hidden" name="motivoDescuento">
</form>
</body>
</html>
