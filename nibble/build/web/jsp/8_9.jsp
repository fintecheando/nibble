...
function por_parte_onclick(form){
    var errors = '';
	var numErrors = 0;
...
function por_clasificacion_onclick(form){
    var errors = '';
	var numErrors = 0;
...
<tr>
	<td><img src="<%= beanClasificacion.getImagen() %>"></td>
        ...
        <th>
	<td><a href="../pvatx/hlp/pva8.0-8.9.htm" target="Ayuda Reporte de Valuacion de Inv.">Ayuda</a></td>
        </th>
</tr>
</table>
<br>
...
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
<tr class="titStyle">
	<td align=center><input type="submit" value="Por Parte" class=body onclick="return por_parte_onclick(this.form)">
		<input type="submit" value="Por Clasificación" class=body onclick="return por_clasificacion_onclick(this.form)">	
