...
<tr class="itemStyle">
	<td><input type=text name="vchcolonia" class="body" size=35 maxlength="60"></td>
	<td><input type=text name="vchcalle" class="body" size=35 maxlength="60"></td>
...
<tr class="itemStyle">
        <td><input type=text name="vchlocalidad" class="body" size=35 maxlength="60"></td>
	<td><input type=text name="vchnumeroexterior" class="body" size=15 maxlength="40"></td>
	<td><input type=text name="vchnumerointerior" class="body" size=15 maxlength="40"></td>
</tr>
</table>
<br>
<table align="center" border="1" bordercolor="#364859" rules="cols" cellspacing="0" width="750" style="border-color:Black;border-width:1px;border-style:solid;font-family: arial; font-size: 11px;border-collapse:collapse;" class="tablatext">
