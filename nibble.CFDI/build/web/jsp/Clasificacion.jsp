...
function agregar_onclick(form){
	...
	<%if (beanClasificacion.getAccion()==0){%>
	Popup();
	popup.focus();
	form.target="Popup";
	<%}%>	
...
<!-- Modificacion: Se agregan las siguientes instrucciones con fines de prueba 
     Fecha: 26/02/04  Tipo de texto a comparar: "images/tpva8_3.GIF"
     Autor: Ernesto Ramírez Fuentes -->
        <th>
	<td>
        <%if(beanClasificacion.getImagen().matches("images/tpva8_3.GIF")) { %>
            <a href="../pvatx/hlp/pva8.0-8.3.htm" target="Ayuda Ajuste Físico al Inv.">Ayuda</a>
        <%} else if (beanClasificacion.getImagen().matches("images/tpva8_5.GIF")) {%>
            <a href="../pvatx/hlp/pva8.0-8.5.htm" target="Ayuda Registrar Históricos de consumo">Ayuda</a>
        <%} else if (beanClasificacion.getImagen().matches("images/tpva8_6.GIF")) {%>
            <a href="../pvatx/hlp/pva8.0-8.6.htm" target="Ayuda Días de Inv. en Almac.">Ayuda</a>
        <%} else if (beanClasificacion.getImagen().matches("images/tpva8_7.GIF")) {%>
            <a href="../pvatx/hlp/pva8.0-8.7.htm" target="Ayuda Reporte de Toma de Inv.">Ayuda</a>
        <%} else if (beanClasificacion.getImagen().matches("images/tpva8_8.GIF")) {%>
            <a href="../pvatx/hlp/pva8.0-8.8.htm" target="Ayuda Reporte de existencias de Inv.">Ayuda</a>
        <%} else {%>
        <%}%>
        </td>
        </th>
