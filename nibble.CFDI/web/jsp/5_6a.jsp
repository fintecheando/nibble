...
<form name=frm action="ProveedoresMinimoPedido" method="get">
...
<table class="tablatext" width=750 align="center" cellpadding="0" cellspacing="0">
<tr>
	<td align=center><input type="submit" value="Ver proveedores" onclick="return proveedores_onclick(this.form)">
